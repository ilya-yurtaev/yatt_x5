...
var _user$project$Main$mergeRecords = F2(
	function (d, l) {
		mergeRecords:
		while (true) {
			var _p0 = l;
			if (_p0.ctor === '::') {
				var _p4 = _p0._1;
				var _p3 = _p0._0;
				var _p1 = A2(_elm_lang$core$Dict$get, _p3.contact_id, d);
				if (_p1.ctor === 'Just') {
					var _p2 = _p1._0;
					var _v2 = A3(
						_elm_lang$core$Dict$insert,
						...
						_elm_lang$core$Native_Utils.update(
							_p2,
							{
								phone: A2(
									_elm_lang$core$Basics_ops['++'],
									_p2.phone,
									A2(_elm_lang$core$Basics_ops['++'], ', ', _p3.phone))
							}),
						d),
						_v3 = _p4;
					d = _v2;
					l = _v3;
					continue mergeRecords;
				} else {
					var _v4 = A3(_elm_lang$core$Dict$insert, _p3.contact_id, _p3, d),
						_v5 = _p4;
					d = _v4;
					l = _v5;
					continue mergeRecords;
...
var _user$project$Main$recordView = function (record) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(record.full_name),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(record.address),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(record.phone),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$Main$recordList = function (_p5) {
	return A2(
		_elm_lang$core$List$map,
		_user$project$Main$recordView,
		A2(
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Das Addressbuch'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('table table-sm'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									{ctor: '[]'},
									_user$project$Main$recordList(
										_elm_lang$core$Dict$values(model.records))),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$Main$baseUrl = 'http://localhost:8080';
		...
		return _elm_lang$http$Http$request(
			{
				method: 'GET',
				headers: {ctor: '[]'},
				url: A2(_elm_lang$core$Basics_ops['++'], _user$project$Main$baseUrl, url),
				body: _elm_lang$http$Http$emptyBody,
				expect: _elm_lang$http$Http$expectJson(decoder),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
...
var _user$project$Main$Record = F5(
	function (a, b, c, d, e) {
		return {full_name: a, address: b, phone: c, contact_id: d, created_at: e};
	});
var _user$project$Main$recordDecode = A6(
	...
	A2(_elm_lang$core$Json_Decode$field, 'contact_id', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'created_at', _elm_lang$core$Json_Decode$string));
var _user$project$Main$recordsDecode = _elm_lang$core$Json_Decode$list(_user$project$Main$recordDecode);
var _user$project$Main$Model = F2(
	function (a, b) {
		return {records: a, last_dt: b};
	});
...
var _user$project$Main$subscriptions = function (model) {
	return A2(_elm_lang$core$Time$every, 5 * _elm_lang$core$Time$second, _user$project$Main$Tick);
};
var _user$project$Main$SetDt = function (a) {
	return {ctor: 'SetDt', _0: a};
};
var _user$project$Main$RecordsFetched = function (a) {
	return {ctor: 'RecordsFetched', _0: a};
};
var _user$project$Main$fetchRecords = function (mb_date) {
	var _p6 = mb_date;
	if (_p6.ctor === 'Nothing') {
		return A2(
			_elm_lang$http$Http$send,
			_user$project$Main$RecordsFetched,
			A2(_user$project$Main$fetch, '/api/v1/phonebook/', _user$project$Main$recordsDecode));
	} else {
		return A2(
			_elm_lang$http$Http$send,
			_user$project$Main$RecordsFetched,
			A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					'/api/v1/phonebook/?created_at__gt=',
					_rluiten$elm_date_extra$Date_Extra_Format$utcIsoString(_p6._0)),
				_user$project$Main$recordsDecode));
	}
};
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: {records: _elm_lang$core$Dict$empty, last_dt: _elm_lang$core$Maybe$Nothing},
	_1: _user$project$Main$fetchRecords(_elm_lang$core$Maybe$Nothing)
};
					...
					if (_p8.ctor === '::') {
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									records: A2(_user$project$Main$mergeRecords, model.records, _p9)
								}),
							_1: A2(_elm_lang$core$Task$perform, _user$project$Main$SetDt, _elm_lang$core$Date$now)
						};
					} else {
			...
			case 'SetDt':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							last_dt: _elm_lang$core$Maybe$Just(_p7._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Tick':
				var _p10 = model.last_dt;
				if (_p10.ctor === 'Nothing') {
					...
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _user$project$Main$fetchRecords(
